...
export function injectLabelStudioInspectionBridge(
  html: string,
  protocol: LabelStudioInspectionProtocol,
): string {
  void protocol
  if (html.includes(`src="${LABEL_STUDIO_FRAME_BRIDGE_PATH}"`)) return html
 ...
 */
export function renderLabelStudioFrameBridgeScript(
  protocol: LabelStudioInspectionProtocol,
  capability: string,
): string {
