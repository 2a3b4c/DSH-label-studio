 ...
 */
export function parseLabelStudioTargetInput(input) {
    ...
    return {
        ...
        ...(annotation === undefined || annotation === ''
            ? {}
            : { annotationId: positiveId(annotation, 'annotationId') }),
    };
}
/**
 ...
 */
export function buildLabelStudioPageUrl(baseUrl, page) {
 ...
 */
export function targetOfPage(page) {
    return {
