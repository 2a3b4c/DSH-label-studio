...
export declare function LabelStudioRoot({ useStore, actions, useSessions, renderSlot, SessionProvider, useLabelStudioPanel, useLabelStudioContext, baseUrl, bindSession, confirmApplied, attachFrame, selectTarget, selectPage, close, reload, openExternal, t, }: LabelStudioRootProps): import("react").JSX.Element;
